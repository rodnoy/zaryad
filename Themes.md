# Темы (Themes) — реализация в этом проекте (ChargerMonitor)

Этот документ описывает, как темы реализованы в приложении ChargerMonitor, как их переключать и обновлять, а также как добавить новую тему в проект.
